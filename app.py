...
# Create a new dataframe with all the reviews and their tf-idf representation. This wil be used for prediction 
if not model_path.exists() or not pred_path.exists():
    picklefiles.prediction(reviews_df)  

# Create the recommendation dataframe in a pickle file
if not recommend_path.exists():
    picklefiles.recommendation(reviews_df)  
